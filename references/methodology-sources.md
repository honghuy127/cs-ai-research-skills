...
| python-pptx documentation | https://python-pptx.readthedocs.io/en/latest/ | Reproducible `.pptx` generation and patching from recorded scripts | Third-party dependency, not bundled with this skill; verify API behavior per installed release |
